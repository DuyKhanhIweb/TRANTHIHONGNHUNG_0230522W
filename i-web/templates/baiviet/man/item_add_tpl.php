                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Tên không được để trống" onkeyup="changeSlug('name_<?=$k?>','alias_<?=$k?>','url_seo_<?=$k?>','title_seo_<?=$k?>','title_<?=$k?>')" name="data[ten_<?=$k?>]" title="Nhập tên danh mục" id="name_<?=$k?>"
                                ...
                                <div class="formRight">
                                    ...
                                    <div class="box-alias"
                                        ...
                                        <div style="position: relative;-ms-flex: 1 1 auto;flex: 1 1 auto;width: 1%;margin-bottom: 0;"    >
                                            ...
                                            <input onblur="changeUrl('alias_<?=$k?>','url_seo_<?=$k?>')" data-validation="required" data-validation-error-msg="Url không được để trống"

                                                type="text" name="data[tenkhongdau_<?=$k?>]" title="Nhập tên không dấu" id="alias_<?=$k?>"

                                                class="tipS" value="<?=@$item['tenkhongdau_'.$k]?>"/>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Link không được để trống" name="data[link]" title="Nhập link" id="link"

                                class="tipS" value="<?=@$item['link']?>" />
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Không được để trống" name="data[job_<?=$k?>]" title="Nhập địa chỉ" id="job_<?=$k?>"

                                class="tipS" value="<?=@$item['job_'.$k]?>" />
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div class="ck_editor">
                            ...
                            <textarea data-validation="required" data-validation-error-msg="Không được để trống" title="Nhập nội dung [<?=$v?>]. " data-height="400" id="noidung_<?=$k?>"
            ...
            <div class="<?=($table['full']==true) ? 'oneOne':'colRight' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <?php /*  if($_GET['type']=='san-pham'){
                        ...
                        $brands=$db->rawQuery("select * from table_baiviet_list where type='thuong-hieu' order by stt asc, id desc");
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Không được để trống" name="data[masp]" title="Nhập mã sản phẩm" id="masp" class="tipS"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[xuatxu]" title="Nhập mã sản phẩm" id="xuatxu"

                                class="tipS" value="<?=@$item['xuatxu']?>" />
                    ...
                    <?php if($GLOBAL[$com][$type]['rating']==true){?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[rating]"  title="Nhập số sao cẩn đánh giá" id="rating"
                                    ...
                                    class="tipS conso" value="<?=@$item['rating']?>" style="font-size: 12px;padding: 7px 6px;background: white;border: 1px solid #DDD;width: 100%;font-family: Arial, Helvetica, sans-serif;color: #656565;box-sizing: border-box;"/>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[baohanh]" title="Nhập mã sản phẩm" id="baohanh"

                                class="tipS" value="<?=@$item['baohanh']?>" />
                    ...
                    <?php if($table['donvitinh']==true){ ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[donvitinh]" title="Nhập đơn vị tính" id="donvitinh" class="tipS"
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_loai]" id="id_loai" class="main_select">
                                    ...
                                    <option value="2" <?=(@$item['id_loai']==2) ? 'selected':''?>>Tạm hết hàng
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <div class="mt10"><img style="max-width:100%" src="<?=_upload_baiviet.$item['photo']?>" alt="NO PHOTO"

                                    width="<?=$table['img-width']?>" height="<?=$table['img-height']?>" /></div>
                    ...
                    <?php 
                        ...
                        $data_combo = $db->rawQuery("select id,ten_vi from #_baiviet where type=? and hienthi=1 order by stt asc,id desc",array('san-pham'));
                        
                        $ex_tags = json_decode($item['combo'],true);  
                    ?>

                    <div class="formRow">

                        <label>Chọn combo <?=$GLOBAL[$com][$type]['title_main']?></label>

                        <div class="formRight">

                            <select multiple="multiple" name="data[combo][]" class="select2">

                                <?php foreach ($data_khuyenmai as $k => $v) { ?>
                                    <option value="<?=$v['id']?>" <?=(isset($ex_tags) && count($ex_tags)>0) ? ((in_array($v['id'],$ex_tags)) ? 'selected':''):''?>><?=$v['ten_vi']?></option>
                                <?php } ?>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" class="tipS" value="<?=isset($item['stt'])?$item['stt']:$func->checkNumb('stt',$com,$type)?>"
                        ...
                        <?php  foreach ($config['seo-lang'] as $k => $v){ ?>
                            ...
                            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                                ...
                                <div class="formRight">
                                    ...
                                    <input type="text" data-validation="required" data-validation-error-msg="Không được để trống" value="<?=@$seoDB['title_'.$k]?>" id="title" name="dataseo[title_<?=$k?>]"
                            ...
                            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                                ...
                                <div class="formRight">
                                    ...
                                    <textarea rows="4" data-validation="required" data-validation-error-msg="Không được để trống" cols="" title="Nội dung thẻ meta Description dùng để SEO" class="tipS input100"
