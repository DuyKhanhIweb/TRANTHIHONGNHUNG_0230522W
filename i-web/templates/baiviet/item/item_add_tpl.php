<?php if($GLOBAL_LEVEL3[$com][$type]['seo']==true){ ?>
<script>
    ...
    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a
                        href="index.html?com=baiviet&act=add_item&tbl=<?=$_GET['tbl']?><?php if($_REQUEST['id']!='') echo'&id='. $_REQUEST['id'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span><?=$GLOBAL_LEVEL3[$com][$type]['title']?></span></a>
                </li>
                <li class="current"><a href="#"
                        onclick="return false;"><?=($_GET['act']=='edit_item') ? 'Sửa':'Thêm'?></a></li>
            </ul>
            <div class="clear"></div>
        </div>
    </div>

    <form name="supplier" id="validate" class="form form-validate"
        action="index.html?com=baiviet&act=save_item&tbl=<?=$_GET['tbl']?><?php if($_REQUEST['id']!='') echo'&id='. $_REQUEST['id'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"
        ...
        <div class="mtop0">
            ...
            <div class="<?=($GLOBAL_LEVEL3[$com][$type]['full']==true) ? 'oneOne':'colLeft' ?>">
                <div class="widget mtop0">
                                ...
                                <div class="formRight">
                                    <div class="box-alias"
                                        ...
                                        <div style="position: relative;-ms-flex: 1 1 auto;flex: 1 1 auto;width: 1%;margin-bottom: 0;">
                                            <input readonly data-validation="required" data-validation-error-msg="Url không được để trống"
                    ...
                    <?php }?>
                    <?php  foreach ($config['lang'] as $k => $v){ ?>
                    <?php if($GLOBAL_LEVEL3[$com][$type]['mota']==true){ ?>
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        <label><?=_mota?> [<?=$v?>]</label>
                        <div class="formRight">
                            <div
                                <?php if($GLOBAL_LEVEL3['baiviet']['san-pham']['mota-ckeditor']==true) echo 'class="ck_editor"'; ?>>
                                <textarea title="Nhập mô tả . " data-height="400" id="mota_<?=$k?>"
                                    <?=($GLOBAL_LEVEL3[$com][$type]['mota-ckeditor']==true) ? 'class="ck_editors"':'rows="8"' ?>
                    ...
                    <?php } ?>
                    <?php if($GLOBAL_LEVEL3[$com][$type]['noidung']==true){ ?>
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        <label><?=_noidung?> [<?=$v?>]</label>
                        <div class="formRight">
                            <div
                                <?php if($GLOBAL_LEVEL3['baiviet']['san-pham']['noidung-ckeditor']==true) echo 'class="ck_editor"'; ?>>
                                <textarea title="Nhập mô tả . " data-height="400" id="noidung_<?=$k?>"
                                    <?=($GLOBAL_LEVEL3[$com][$type]['noidung-ckeditor']==true) ? 'class="ck_editors"':'rows="8"' ?>
            ...
            <div class="<?=($GLOBAL_LEVEL3[$com][$type]['full']==true) ? 'oneOne':'colRight' ?>">
                <div class="widget mtop0">
                    <div class="title"><img src="./images/icons/dark/record.png" alt="" class="titleIcon" />
                        <h6><?=_danhmuc?></h6>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <select class="main_select" name="data[id_cat]" id="id_cat">
                    ...
                    <?php } ?>
                    <?php if($GLOBAL_LEVEL3[$com][$type]['img']==true){ ?>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <span style="display: inline-block; line-height: 30px;color:#CCC; padding-left: 10px;">
                                Width:
                                <?=$GLOBAL_LEVEL3[$com][$type]['img-width']*$GLOBAL_LEVEL3[$com][$type]['img-ratio']?>px
                                -
                                <?=$GLOBAL_LEVEL3[$com][$type]['img-height']*$GLOBAL_LEVEL3[$com][$type]['img-ratio']?>px
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        <div class="formRight">
                            ...
                            <input type="text" class="tipS" value="<?=isset($item['stt'])?$item['stt']:$func->checkNumb('stt',$com.'_item',$type)?>"
                ...
                <?php if($GLOBAL_LEVEL3[$com][$type]['seo']==true){ ?>
                   <?php if(isset($GLOBAL_LEVEL3[$com][$type]['seo'])&&$GLOBAL_LEVEL3[$com][$type]['seo']==true){
        ...
        <div class="formRow fixedBottom">
            <div class="formRight">
                    ...
                    <div class="box-action">
                        ...
                        <a class="btn btn-sm bg-gradient-danger text-white" href="index.html?com=baiviet&act=man_item<?php if($_REQUEST['id']!='') echo'&id='. $_REQUEST['id'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>">
