...
<!-- Canonical -->
<link rel="canonical" href="<?=(!empty($row_cano)) ? $row_cano : $func->getCurrentPageURL()?>" />
...
<?php }?>
<!-- Robots -->
<meta name="robots" content="<?=$config['website']['robots']?>" />
<!-- Favicon -->
...
<meta property="ia:markup_url" content="<?=$func->getCurrentPageURL()?>">
<meta property="ia:rules_url" content="<?=$func->getCurrentPageURL()?>">
